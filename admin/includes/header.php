            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="manage_category.php">
                                <i class="fas fa-tachometer-alt"></i>Manage Category</a>
                            
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="manage_prodact.php">
                                <i class="fas fa-tachometer-alt"></i>Manage Prodact</a>
                            
                        </li>
                        
                        <li class="has-sub">
                            <a class="js-arrow" href="manage_user.php">
                                <i class="fas fa-tachometer-alt"></i>Manage User</a>
                            
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="manage_order.php">
